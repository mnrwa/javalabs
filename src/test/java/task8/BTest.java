...
import ru.bahanov.pracJava.task8.B.B;
...
public class BTest {
    ...
    public void testRemoveExtraSpaces() {
        ...
        String cleanedText = B.cleanText(input);
    ...
    public void testSortWordsAlphabetically() {
        ...
        List<String> sortedWords = B.sortWords(new ArrayList<>(words)); // Создаем копию для мутации
